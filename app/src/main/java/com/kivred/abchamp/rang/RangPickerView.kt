...
//                    onChangeListener?.onProgressChanged(this, getCurrentStartValue(), getCurrentEndValue(), true)
    ...
    interface OnRubberRangePickerChangeListener {
        fun onProgressChanged(rangePicker: RangPickerView, startValue: Int, endValue: Int, fromUser: Boolean)
        fun onStartTrackingTouch(rangePicker: RangPickerView, isStartThumb: Boolean)
        fun onStopTrackingTouch(rangePicker: RangPickerView, isStartThumb: Boolean)
    }
    //endregion
